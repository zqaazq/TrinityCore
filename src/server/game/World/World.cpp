...
void World::LoadConfigSettings(bool reload)
{
    ...
    rate_values[RATE_DUNGEON_CREATURE_NORMAL_DAMAGE]          = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Normal.Damage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_ELITE_DAMAGE]     = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.Elite.Damage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_RAREELITE_DAMAGE] = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.RAREELITE.Damage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_WORLDBOSS_DAMAGE] = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.WORLDBOSS.Damage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_RARE_DAMAGE]      = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.RARE.Damage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_NORMAL_HP]          = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Normal.HP", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_ELITE_HP]     = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.Elite.HP", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_RAREELITE_HP] = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.RAREELITE.HP", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_WORLDBOSS_HP] = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.WORLDBOSS.HP", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_RARE_HP]      = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.RARE.HP", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_NORMAL_SPELLDAMAGE]          = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Normal.SpellDamage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_ELITE_SPELLDAMAGE]     = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.Elite.SpellDamage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_RAREELITE_SPELLDAMAGE] = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.RAREELITE.SpellDamage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_WORLDBOSS_SPELLDAMAGE] = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.WORLDBOSS.SpellDamage", 1.0f);
    rate_values[RATE_DUNGEON_CREATURE_ELITE_RARE_SPELLDAMAGE]      = sConfigMgr->GetFloatDefault("Rate.Dungeon.Creature.Elite.RARE.SpellDamage", 1.0f);
