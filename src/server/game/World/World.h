...
enum Rates
{
    ...
    RATE_DUNGEON_CREATURE_NORMAL_HP,
    RATE_DUNGEON_CREATURE_ELITE_ELITE_HP,
    RATE_DUNGEON_CREATURE_ELITE_RAREELITE_HP,
    RATE_DUNGEON_CREATURE_ELITE_WORLDBOSS_HP,
    RATE_DUNGEON_CREATURE_ELITE_RARE_HP,
    RATE_DUNGEON_CREATURE_NORMAL_DAMAGE,
    RATE_DUNGEON_CREATURE_ELITE_ELITE_DAMAGE,
    RATE_DUNGEON_CREATURE_ELITE_RAREELITE_DAMAGE,
    RATE_DUNGEON_CREATURE_ELITE_WORLDBOSS_DAMAGE,
    RATE_DUNGEON_CREATURE_ELITE_RARE_DAMAGE,
    RATE_DUNGEON_CREATURE_NORMAL_SPELLDAMAGE,
    RATE_DUNGEON_CREATURE_ELITE_ELITE_SPELLDAMAGE,
    RATE_DUNGEON_CREATURE_ELITE_RAREELITE_SPELLDAMAGE,
    RATE_DUNGEON_CREATURE_ELITE_WORLDBOSS_SPELLDAMAGE,
    RATE_DUNGEON_CREATURE_ELITE_RARE_SPELLDAMAGE,
    RATE_CREATURE_AGGRO,
    RATE_REST_INGAME,
